...
def main(suite):
	if suite == "locomotion":
		...
		env_names = ['pen', 'hammer', 'door', 'relocate']
		dataset_types = ['human', 'cloned', 'expert']
		names = [f'{env_name}-{dataset_type}-v0' for env_name in env_names for dataset_type in dataset_types]
		keys = ['observations', 'actions', 'rewards', 'terminals']        
...
if __name__ == '__main__':
	...
	parser.add_argument(
      	...
      	default="locomotion", 
       	type=str,
        choices=["locomotion", "antmaze", 'adroit'],
